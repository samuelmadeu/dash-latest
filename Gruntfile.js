...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            livereload: {
                ...
                files: [
                    '<%= sobold.app %>/**/*.html',
                    '.tmp/styles/{,*/}*.css',
                    '<%= sobold.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
                ]
            }
        },
        ...
        filerev: {
            dist: {
                src: [
                    '<%= sobold.dist %>/scripts/{,*/}*.js',
                    '<%= sobold.dist %>/styles/{,*/}*.css',
                    '<%= sobold.dist %>/styles/fonts/*'
                ]
            }
        },
        htmlmin: {
              ...
              patterns: [
                {
                    ...
                    replacement: function () {
                        return grunt.option('env') || 'production'; // replaces "foo" to "bar" 
                    }
                }
              ]
            },
            files: [
              {expand: true, flatten: true, src: ['dist/scripts/scripts*.js'], dest: 'dist/scripts'}
            ]
          }
        }
    });
